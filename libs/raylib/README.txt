...
Directory is self-contained and portable, including all required tools:
 ...
 - raylib 4.5 library with source code, examples and several preconfigured projects
 - Notepad++ 8.5 (npp) preconfigured with some scripts to compile raylib and examples
 - Portable C and C++ Development Kit for x64 Windows (https://github.com/skeeto/w64devkit)
     - w64devkit 1.18.0 contains multiple tools and MinGW-w64 with GCC 12.2.0 (64bit)
